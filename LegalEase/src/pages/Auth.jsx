      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="space-y-6">
            {[t('auth_feature_1'), t('auth_feature_2'), t('auth_feature_3')].map((text, i) => (
          ...
          {/* ✅ FIXED SECTION: Use exact lowercase keys from i18n.js */}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="max-w-md w-full">
          ...
          <form onSubmit={handleLogin} className="space-y-5 text-left">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="w-full pl-12 pr-4 py-4 bg-white border-2 border-slate-100 rounded-2xl text-slate-900 placeholder-slate-400 focus:border-red-600 outline-none transition-all shadow-sm font-medium" placeholder="••••••••" />
              </div>
            </div>
          ...
          <p className="text-center mt-12 text-slate-500 text-sm font-medium">
            {t('no_account')} 
            <Link to="/signup" className="text-red-600 font-black ml-2 hover:underline underline-offset-4 decoration-2">
              {t('create_account')}
            </Link>
          </p>
        </div>
