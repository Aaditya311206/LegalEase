...
const resources = {
  ...
  hi: {
    translation: {
      ...
      "home_desc": "अपने कानूनी दस्तावेज अपलोड करें और हमारे इंजन को हस्ताक्षर करने से पहले जोखिमों का पता लगाने दें।",
  ...
  ta: {
    translation: {
      ...
      "create_account_title": "கணக்கை உருவாக்கவும்", "join_legalease": "சேருங்கள்", "signup_desc": "இன்றே தொடங்குங்கள்.", "full_name": "முழு பெயர்", "register_btn": "பதிவுசெய்", "already_account": "கணக்கு உள்ளதா?", "email_label": "மின்னஞ்சல்", "password_label": "கடவுச்சொல்", "login_btn": "உள்நுழை", "create_account": "கணக்கை உருவாக்கவும்",
  ...
  te: {
    translation: {
      ...
      "create_account_title": "ఖాతాను సృష్టించండి", "join_legalease": "చేరండి", "signup_desc": "నేడే ప్రారంభించండి.", "full_name": "పూర్తి పేరు", "register_btn": "నమోదు చేయండి", "already_account": "ఖాతా ఉందా?", "email_label": "ఈమెయిల్", "password_label": "పాస్‌వర్డ్", "login_btn": "సైన్ ఇన్", "create_account": "ఖాతా సృష్టించండి",
  ...
  mr: {
    translation: {
      ...
      "create_account_title": "खाते तयार करा", "join_legalease": "सामील व्हा", "signup_desc": "प्रवास सुरू करा.", "full_name": "पूर्ण नाव", "register_btn": "नोंदणी करा", "already_account": "खाते आहे?", "email_label": "ईमेल", "password_label": "पासवर्ड", "login_btn": "साइन इन", "create_account": "खाते तयार करा",
      "app_title": "स्मार्ट दस्तऐवज तपासक", "upload_desc": "आमचे इंजिन त्वरित तपासणी करते.", "select_doc_type": "श्रेणी निवडा", "placeholder_doc_type": "-- प्रकार निवडा --", "warn_select_type": "आधी श्रेणी निवडा", "drop_file": "इथे टाका", "upload_instruction": "फाईल इथे ड्रॅग करा", "browse_files": "फायली शोधा", "secure_processing": "दस्तऐवज जतन केले जात नाहीत.", "analyzing": "ऑडिट सुरू आहे", "analyzing_status": "पडताళणी सुरू आहे...", "analyze_btn": "ऑडिट सुरू करा", "cancel_btn": "रद्द",
      "dash_welcome": "डॅशबोर्डवर स्वागत", "dash_desc": "विश्लेषणाचे విహంగావलोकन.", "analyze_new": "नवीन विश्लेषण", "total_analyzed": "एकूण", "risks_detected": "धोके", "hours_saved": "तास", "recent_docs": "अलीकडील दस्तऐवज", "doc_name": "नाव", "type": "प्रकार", "date": "तारीख", "safety_score": "स्कोर", "view_report": "पहा", "no_docs": "आढळले नाहीत.", "latest_tag": "क्रियाकलाप", "action": "कृती",
